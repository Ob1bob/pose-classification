...
def data_generate_options():
    ...
    parser.add_argument("-i", "--input", default=os.path.join(cwd, "data", "openpose", "pose_data-subset3.csv"), type=str,
                        help='path to csv with OpenPose key points')
    parser.add_argument("-o", "--output", default=os.path.join(cwd, "data"), type=str,
