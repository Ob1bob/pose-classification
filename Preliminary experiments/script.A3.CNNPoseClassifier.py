...
if __name__ == "__main__":
    ...
    dataset_name = config.get('CNNClassifier', 'dataset_name')
    dataset_augmentation = config.get('CNNClassifier', 'dataset_augmentation')
    dataset_dir = os.path.join(os.path.abspath(config.get('Global', 'dataset_dir')), dataset_name)
    log_dir = os.path.join(os.path.abspath(config.get('CNNClassifier', 'log_dir')), dataset_name)
